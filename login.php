...
<head>
  ...
  <title>CHILD BIRTH FORCASTING SYSTEM</title>
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="index.html"></span>&nbsp;&nbsp;CHILD BIRTH FORCASTING SYSTEM</a>
    ...
    <div class="card card-login mx-auto mt-5">
      ...
      <div class="card-body"><?php $lib->msg();?>
        ...
        <div class="text-center">
           <a class="small mt-3" href="index.html"><u>Back to Home</u></a>
        </div>
      </div>
    </div>
<br/>
